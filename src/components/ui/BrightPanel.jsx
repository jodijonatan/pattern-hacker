    ...
    <BrightCard className={`relative overflow-hidden ${className}`} {...props}>
      {title && (
        <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-primary/5">
          <div className="w-4 h-4 bg-green shadow-[2px_2px_0_0_var(--shadow-color)]"></div>
          <div className="w-4 h-4 bg-yellow shadow-[2px_2px_0_0_var(--shadow-color)]"></div>
          <div className="w-4 h-4 bg-peach shadow-[2px_2px_0_0_var(--shadow-color)]"></div>
